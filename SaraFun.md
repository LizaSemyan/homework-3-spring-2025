...
#### После успешного прохождения всех этапов создания рекламная кампания создается и отображается в списке кампаний
...
6. Из списка пропала кампания с названием "Тест", показывается сообщение "Создайте первую рекламную кампанию"
