...
#### В расширенном окне загрузки списка при вводе названия длиной от 1 до 255, вводе окна атрибуйии от 1 до 90, выбора типа списка, загрузке валидного файла и после нажатия сохранения созданный список сохраняется
